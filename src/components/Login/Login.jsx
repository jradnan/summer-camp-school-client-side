...
const Login = () => {
    ...
    return (
        <div className="mt-16 lg:mt-0 w-full lg:w-auto ">
            <div className="mx-auto max-w-sm shadow-2xl rounded-xl bg-black px-4 py-6 lg:p-8">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="form-control">
                        ...
                        <label className="label">
                            <span className="label-text-alt link link-hover text-red-600">{error}</span>
                        </label>
                    </div>
                    <div className="form-control">
                        <input className="btn bg-[#9f2ee5] text-white w-full" type="submit" value="Login" />
                    </div>
                </form>
                ...
                <p className='text-center text-white pb-5'>
                    <small>New Here? <Link to="/signUp"><span className="text-[#9f2ee5]">Create an account</span></Link></small>
                </p>
            </div>
        </div>
    );
